...
public enum ActionId {
    ...
    CONTAINER_CREATE_DRAFT, CONTAINER_DELETE, CONTAINER_PUBLISH,
    CONTAINER_REMOVE_DOCUMENT, CONTAINER_REVERT_DOCUMENT, CONTAINER_SEARCH,
    DOCUMENT_OPEN, DOCUMENT_OPEN_VERSION, DOCUMENT_RENAME,
