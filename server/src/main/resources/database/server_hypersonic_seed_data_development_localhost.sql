...
insert into jiveProperty(NAME,PROPVALUE) values('xmpp.server.socket.port','5271');
insert into jiveProperty(NAME,PROPVALUE) values('xmpp.socket.plain.port','5226');
...
insert into jiveProperty(NAME,PROPVALUE) values('xmpp.socket.ssl.port','5227');
