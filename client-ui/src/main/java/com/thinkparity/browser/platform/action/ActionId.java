...
public enum ActionId {
    ...
    CONTACT_DELETE, CONTACT_DELETE_OUTGOING_INVITATION, CONTACT_READ,
     CONTAINER_ADD_DOCUMENT, CONTAINER_CREATE,
    CONTAINER_CREATE_DRAFT, CONTAINER_DELETE, CONTAINER_DELETE_DRAFT,
    CONTAINER_PUBLISH, CONTAINER_REMOVE_DOCUMENT, CONTAINER_REVERT_DOCUMENT, CONTAINER_SHARE, DOCUMENT_OPEN, DOCUMENT_OPEN_VERSION,
    DOCUMENT_RENAME, DOCUMENT_UPDATE_DRAFT, PLATFORM_BROWSER_DISPLAY_INFO,
    PLATFORM_BROWSER_MOVE_TO_FRONT, PLATFORM_BROWSER_OPEN_HELP,
    PLATFORM_BROWSER_RESTORE, PLATFORM_LOGIN, PLATFORM_LOGOUT, PLATFORM_QUIT,
    PLATFORM_RESTART, PROFILE_ADD_EMAIL, PROFILE_REMOVE_EMAIL,
    PROFILE_RESET_PASSWORD, PROFILE_SIGN_UP, PROFILE_UPDATE,
