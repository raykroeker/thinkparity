...
public enum ActionId {
    ...
    CONTAINER_ADD_DOCUMENT, CONTAINER_CREATE, CONTAINER_CREATE_DRAFT, CONTAINER_DELETE,
    CONTAINER_DELETE_DRAFT, CONTAINER_EXPORT, CONTAINER_PRINT, CONTAINER_PUBLISH,
    CONTAINER_REMOVE_DOCUMENT, CONTAINER_REVERT_DOCUMENT, CONTAINER_SHARE,
    CONTAINER_UNDELETE_DOCUMENT,
    
    DOCUMENT_OPEN, DOCUMENT_OPEN_VERSION, DOCUMENT_RENAME, DOCUMENT_UPDATE_DRAFT,
    
    PLATFORM_BROWSER_DISPLAY_INFO, PLATFORM_BROWSER_MOVE_TO_FRONT, PLATFORM_BROWSER_OPEN_HELP,
