...
public class UserProfileAvatar extends Avatar {
    ...
    private void initComponents() {
        ...
        userInfoJPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("UserProfileAvatar.UserInfoTitle")));
        userInfoJPanel.setOpaque(false);
        nameJLabel.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("UserProfileAvatar.NameLabel"));

        organizationJLabel.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("UserProfileAvatar.OrganizationLabel"));

        titleJLabel.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("UserProfileAvatar.TitleLabel"));

        eaJLabel.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("UserProfileAvatar.EmbeddedAssistance"));

        finishJButton.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("UserProfileAvatar.SaveButton"));
        ...
        cancelJButton.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("UserProfileAvatar.CancelButton"));
