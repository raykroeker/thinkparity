...
public enum AvatarId {
    ...
    DIALOG_CONTACT_INFO, DIALOG_CONTAINER_CREATE, DIALOG_CONTAINER_PUBLISH,
    DIALOG_CONTAINER_RENAME, DIALOG_CONTAINER_RENAME_DOCUMENT,
    DIALOG_CONTAINER_VERSION_COMMENT, DIALOG_ERROR, DIALOG_ERROR_DETAILS,
    DIALOG_FILE_CHOOSER, DIALOG_PLATFORM_CONFIRM_SYNCHRONIZE,
    DIALOG_PLATFORM_LOGIN, DIALOG_PLATFORM_SIGNUP,
    DIALOG_PLATFORM_SIGNUP_ACCOUNT, DIALOG_PLATFORM_SIGNUP_AGREEMENT,
    DIALOG_PLATFORM_SIGNUP_PROFILE,
    DIALOG_PROFILE_UPDATE, DIALOG_PROFILE_UPDATE_PASSWORD,
    DIALOG_PROFILE_VERIFY_EMAIL, MAIN_CONTENT, MAIN_STATUS,
