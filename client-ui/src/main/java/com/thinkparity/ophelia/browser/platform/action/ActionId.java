...
public enum ActionId {
    ...
    CONTACT_DELETE_OUTGOING_INVITATION, CONTACT_DISPLAY_INVITATION_INFO, CONTACT_READ,
    ...
    CONTAINER_DISPLAY_VERSION_INFO, CONTAINER_DISPLAY_FLAG_SEEN_INFO, CONTAINER_EXPORT,
    CONTAINER_EXPORT_VERSION, CONTAINER_PRINT_DRAFT,
    ...
    CONTAINER_REVERT_DOCUMENT, CONTAINER_SUBSCRIBE, CONTAINER_UNDELETE_DOCUMENT,
