...
insert into TPSD_PRODUCT_RELEASE(PRODUCT_ID,RELEASE_NAME,RELEASE_OS,RELEASE_DATE) select PRODUCT_ID,'DEVELOPMENT','LINUX',CURRENT_TIMESTAMP from TPSD_PRODUCT where PRODUCT_NAME='OpheliaProduct';
insert into TPSD_PRODUCT_RELEASE(PRODUCT_ID,RELEASE_NAME,RELEASE_OS,RELEASE_DATE) select PRODUCT_ID,'DEVELOPMENT','WINDOWS_XP',CURRENT_TIMESTAMP from TPSD_PRODUCT where PRODUCT_NAME='OpheliaProduct';
...
insert into TPSD_USER_EMAIL(USER_ID,EMAIL_ID,VERIFIED) values(7000,5000,'1');

insert into TPSD_USER(USERNAME,PASSWORD,SECURITY_QUESTION,SECURITY_ANSWER,ACTIVE,DISABLED,VCARD,CREATED_ON) values('thinkparity-backup','DMnBhTS/KlVqMZTwRqwTNw==','What is the city where you were born?','p0B7MKs7hs21lMFBgHe/+g==','1','0','',current_timestamp);
insert into TPSD_EMAIL(EMAIL) values('thinkparity+backup@thinkparity.com');
insert into TPSD_USER_EMAIL(USER_ID,EMAIL_ID,VERIFIED) values(7001,5001,'1');

insert into TPSD_USER(USERNAME,PASSWORD,SECURITY_QUESTION,SECURITY_ANSWER,ACTIVE,DISABLED,VCARD,CREATED_ON) values('thinkparity-support','DMnBhTS/KlVqMZTwRqwTNw==','What is the city where you were born?','p0B7MKs7hs21lMFBgHe/+g==','1','0',' ',current_timestamp);
insert into TPSD_EMAIL(EMAIL) values('thinkparity+support@thinkparity.com');
insert into TPSD_USER_EMAIL(USER_ID,EMAIL_ID,VERIFIED) values(7002,5002,'1');
insert into TPSD_USER_FEATURE_REL(USER_ID,FEATURE_ID) values(7002,6000);
insert into TPSD_USER_FEATURE_REL(USER_ID,FEATURE_ID) values(7002,6001);
