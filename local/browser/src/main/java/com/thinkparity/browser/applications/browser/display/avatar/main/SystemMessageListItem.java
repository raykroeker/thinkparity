 ...
 * Feb 2, 2006
 */
package com.thinkparity.browser.applications.browser.display.avatar.main;
...
public class SystemMessageListItem extends ListItem {
	...
	/**
	 * @see com.thinkparity.browser.applications.browser.display.avatar.main.ListItem#fireSelection()
	 * 
	 */
	...
	/**
	 * @see com.thinkparity.browser.applications.browser.display.avatar.main.ListItem#populateMenu(javax.swing.JPopupMenu)
	 * 
	 */
