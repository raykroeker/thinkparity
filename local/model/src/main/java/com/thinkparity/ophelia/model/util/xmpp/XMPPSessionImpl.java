...
public final class XMPPSessionImpl implements XMPPCore, XMPPSession {
    ...
    /** A <code>ConnectionListener<code> used to monitor session events. */
    ...
    public void clearListeners() {
        ...
        queueListener = null;
        if (null != xmppConnectionListener)
            xmppConnection.removeConnectionListener(xmppConnectionListener);
    ...
    private void login(final Integer attempt, final Environment environment,
        ...
        try {
            ...
            xmppConnectionListener = new ConnectionListener() {
