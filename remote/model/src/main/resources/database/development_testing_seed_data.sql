...
insert into TPSD_USER(USERNAME,PASSWORD,SECURITY_QUESTION,SECURITY_ANSWER,ACTIVE,DISABLED,VCARD,CREATED_ON)
    values('backup','DMnBhTS/KlVqMZTwRqwTNw==','What is the city where you were born?','p0B7MKs7hs21lMFBgHe/+g==','1','0','',current_timestamp);
insert into TPSD_EMAIL(EMAIL)
...
insert into TPSD_USER_FEATURE_REL(USER_ID,FEATURE_ID)
    select USER_ID,FEATURE_ID from TPSD_USER,TPSD_PRODUCT P inner join TPSD_PRODUCT_FEATURE PF on PF.PRODUCT_ID=P.PRODUCT_ID where USERNAME='support' and P.PRODUCT_NAME='OpheliaProduct' and PF.FEATURE_NAME='CORE';
insert into TPSD_USER_FEATURE_REL(USER_ID,FEATURE_ID)
    select USER_ID,FEATURE_ID from TPSD_USER,TPSD_PRODUCT P inner join TPSD_PRODUCT_FEATURE PF on PF.PRODUCT_ID=P.PRODUCT_ID where USERNAME='support' and P.PRODUCT_NAME='OpheliaProduct' and PF.FEATURE_NAME='BACKUP';
