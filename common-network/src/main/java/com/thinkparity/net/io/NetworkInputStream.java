...
public final class NetworkInputStream extends RecordingInputStream {
    ...
    /**
     * @see com.thinkparity.net.io.RecordingInputStream#getLastRead()
     *
     */
    @Override
    ...
    /**
     * @see com.thinkparity.net.io.RecordingInputStream#getRecord()
     *
     */
    @Override
    ...
    /**
     * @see com.thinkparity.net.io.RecordingInputStream#read()
     *
     */
    @Override
    ...
    /**
     * @see com.thinkparity.net.io.RecordingInputStream#read(byte[])
     *
     */
    @Override
    ...
    /**
     * @see com.thinkparity.net.io.RecordingInputStream#read(byte[], int, int)
     *
     */
    @Override
    ...
    /**
     * @see com.thinkparity.net.io.RecordingInputStream#resetRecord()
     *
     */
    @Override
    ...
    /**
     * @see com.thinkparity.net.io.RecordingInputStream#skip(long)
     *
     */
    @Override
