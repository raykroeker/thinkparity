...
public class ApplicationFactory {
	...
	private Application doCreate(final ApplicationId id) {
        ...
        switch(id) {
		case BROWSER:
            application = doCreate(platform, "com.thinkparity.ophelia.browser.application.browser.Browser");
            break;
        case SESSION:
            application = doCreate(platform, "com.thinkparity.ophelia.browser.application.session.SessionApplication");
            break;
		case SYSTEM:
            application =  doCreate(platform, "com.thinkparity.ophelia.browser.application.system.SystemApplication");
            break;
		default:
