...
public enum ActionId {
    ...
    CONTAINER_ADD_DOCUMENT, CONTAINER_ARCHIVE, CONTAINER_CREATE,
    CONTAINER_CREATE_DRAFT, CONTAINER_DELETE, CONTAINER_DELETE_DRAFT,
    CONTAINER_EXPORT, CONTAINER_EXPORT_DRAFT, CONTAINER_EXPORT_VERSION,
    CONTAINER_PRINT_DRAFT, CONTAINER_PRINT_VERSION,
    CONTAINER_PUBLISH, CONTAINER_REMOVE_DOCUMENT, CONTAINER_RENAME,
    CONTAINER_REVERT_DOCUMENT, CONTAINER_SHARE,
