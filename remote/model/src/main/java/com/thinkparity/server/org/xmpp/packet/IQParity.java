...
public abstract class IQParity extends IQ {
	 ...
	 */
	public enum Action {
		ARTIFACTREADCONTACTS, ACCEPTCONTACTINVITATION, CLOSE, CREATE, DECLINECONTACTINVITATION, FLAG, GETKEYHOLDER, GETKEYS, GETSUBSCRIPTION, INVITECONTACT, READCONTACTS, READUSERS, REQUESTKEY, SUBSCRIBE, UNSUBSCRIBE, NOTIFYTEAMMEMBERADDED, NOTIFYTEAMMEMBERREMOVED
	}
}
