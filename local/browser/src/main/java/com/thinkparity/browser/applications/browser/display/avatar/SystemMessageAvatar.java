...
import com.thinkparity.browser.applications.browser.display.provider.SingleContentProvider;
...
class SystemMessageAvatar extends Avatar {
	...
	/**
	 * @see com.thinkparity.browser.platform.application.display.avatar.Avatar#setContentProvider(com.thinkparity.browser.applications.browser.display.provider.ContentProvider)
	 * 
	 */
