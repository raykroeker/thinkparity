 ...
 * @version 1.1.2.1
 */
public abstract class AbstractContainerPanel extends DefaultTabPanel {
     ...
     */
    protected ContainerDraft getDraft() {
        return draft;
    }
    ...
    /**
     * Add a mouse listener to the text icon.
     * 
     * @param mouseListener
     *            A <code>MouseListener</code>.
     */
    protected void addTextIconMouseListener(final MouseListener mouseListener) {
        iconJLabel.addMouseListener(mouseListener);
    }
    ...
    protected void setTextFont(final Font font) {
        containerNameJLabel.setFont(font);
    }
    protected void setTextForeground(final Color foreground) {
        containerNameJLabel.setForeground(foreground);
    }

    protected void setTextIcon(final ImageIcon icon) {
    ...
    private void initBookmarks() {
        iconJLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(final MouseEvent e) {
                ...
                changeCursor(cursor, AbstractContainerPanel.this);
            }
            @Override
            public void mouseExited(final MouseEvent e) {
                changeCursor(null, AbstractContainerPanel.this);
            }           
        });
    }
    /**
