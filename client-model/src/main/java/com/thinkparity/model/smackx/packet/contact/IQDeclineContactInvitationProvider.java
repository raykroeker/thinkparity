 ...
 * @version 1.1
 */
public class IQDeclineContactInvitationProvider implements IQProvider {
	...
	/**
	 * Create a IQDeclineContactInvitationProvider.
	 * 
	 */
	public IQDeclineContactInvitationProvider() {
		super();
	...
	public IQ parseIQ(XmlPullParser parser) throws Exception {
		...
		return new IQDeclineContactInvitation(contact);
	}
