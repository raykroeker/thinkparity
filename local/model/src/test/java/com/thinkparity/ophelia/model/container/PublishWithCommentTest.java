 ...
 * @version $Revision$
 */
public class PublishWithCommentTest extends ContainerTestCase {

    /** Test name. */
    private static final String NAME = "Test Publish With Comment";

    /** Test datum. */
    private Fixture datum;

    /** Create PublishWithCommentTest. */
    public PublishWithCommentTest() { super(NAME); }

    /** Test the publish api. */
    public void testPublish() {
        logger.logTraceId();
        datum.containerModel.publish(
                datum.container.getId(), datum.comment, datum.contacts, datum.teamMembers);
        logger.logTraceId();
    ...
    private class Fixture extends ContainerTestCase.Fixture {
        ...
        private Fixture(final String comment, final List<Contact> contacts,
