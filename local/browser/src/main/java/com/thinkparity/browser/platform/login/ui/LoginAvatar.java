...
public class LoginAvatar extends Avatar {
	...
	public void reload() {
		...
		if(containsErrors()) {
			errorsJLabel.setText(extractErrorMessage());
			clearErrors();
		}
	}
    ...
    private void initComponents() {
        ...
        errorsJLabel = LabelFactory.create();
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(loginJButton))
                    .add(errorsJLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private javax.swing.JLabel errorsJLabel;
