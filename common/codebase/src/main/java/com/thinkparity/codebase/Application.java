...
public enum Application {
    ...
    OPHELIA("Ophelia - thinkParity Client", new ApplicationNature[] {ApplicationNature.SWING}),
    ROSALINE("Rosaline - thinkParity HTTP Server", new ApplicationNature[] {ApplicationNature.HTTP});
