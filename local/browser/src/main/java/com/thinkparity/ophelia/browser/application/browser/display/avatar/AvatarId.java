...
public enum AvatarId {
    ...
    DIALOG_CONTAINER_RENAME_DOCUMENT, DIALOG_CONTAINER_VERSION_COMMENT,
    DIALOG_ERROR, DIALOG_ERROR_DETAILS, DIALOG_FILE_CHOOSER,
    DIALOG_PLATFORM_CONFIRM_SYNCHRONIZE, DIALOG_PLATFORM_LOGIN,
    DIALOG_PLATFORM_SIGNUP, DIALOG_PLATFORM_SIGNUP_ACCOUNT,
    DIALOG_PLATFORM_SIGNUP_AGREEMENT, DIALOG_PLATFORM_SIGNUP_INTRO,
    DIALOG_PLATFORM_SIGNUP_PAYMENT, DIALOG_PLATFORM_SIGNUP_PROFILE,
    DIALOG_PLATFORM_SIGNUP_SUMMARY,
