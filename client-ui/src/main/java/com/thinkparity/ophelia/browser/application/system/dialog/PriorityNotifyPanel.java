...
/**
 * The PriorityNotifyPanel manages the list of priority notifications.
 ...
 * @version $Revision$
 */
public class PriorityNotifyPanel extends SystemPanel {
    ...
    private static final List<PriorityNotification> NOTIFICATIONS;
    ...
    static {
        ...
        NOTIFICATIONS = new Vector<PriorityNotification>();
    }
    ...
    /** Creates new form PriorityNotifyPanel */
    public PriorityNotifyPanel() {
        super();
        initComponents();
     ...
     */
    void display(final PriorityNotification notification) {
     ...
     */
    private NotifyPage getPage(final PriorityNotification notification) {
