...
import com.thinkparity.ophelia.browser.application.browser.display.renderer.dialog.profile.ProfileEMailCellRenderer;
...
public class UpdateProfileAvatar extends Avatar {
    ...
    private void initComponents() {
        ...
        setOpaque(false);
        profileJPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.InnerPanelTitle")));
        profileJPanel.setOpaque(false);
        nameJLabel.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.NameLabel"));

        organizationJLabel.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.OrganizationLabel"));

        titleJLabel.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.TitleLabel"));

        saveJButton.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.SaveButton"));
        ...
        cancelJButton.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.CancelButton"));
        ...
        passwordJLabel.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.PasswordLabel"));

        confirmPasswordJLabel.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.ConfirmPasswordLabel"));

        resetPasswordJButton.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.ResetPasswordButton"));
        ...
        currentPasswordJLabel.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.CurrentPasswordLabel"));
        ...
        emailPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.EmailPanel")));
        ...
        addJButton.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.AddEmailButton"));
        ...
        removeJButton.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.RemoveButton"));
        ...
        verifyJButton.setText(java.util.ResourceBundle.getBundle("localization/JPanel_Messages").getString("DIALOG_PROFILE_UPDATE.VerifyButton"));
