...
/**
 * <b>Title:</b>Clear Incoming EMail Invitation Notifications<br>
 ...
 * @version 1.1.2.1
 */
public final class ClearIncomingEMailInvitationNotifications extends AbstractAction {
     ...
     *
     */
    public ClearIncomingEMailInvitationNotifications(final SystemApplication system) {
        super(ActionId.CONTACT_CLEAR_INCOMING_EMAIL_INVITATION_NOTIFICATIONS);
        this.system = system;
    }
