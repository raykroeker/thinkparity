 ...
 * @version 1.1.2.1
 */
public class IncomingUserInvitationCell extends DefaultInvitationCell {

    /** The incoming user invitation associated with this cell. */
     ...
     */
    public IncomingUserInvitationCell(final IncomingUserInvitation invitation) {
        super();
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        return ((IncomingUserInvitationCell) obj).invitation.equals(invitation);
    }
    ...
    public void triggerPopup(final Connection connection,
        ...
        case ONLINE:
            ...
            jPopupMenu.add(popupItemFactory.createPopupItem(ActionId.CONTACT_ACCEPT_INCOMING_USER_INVITATION, acceptData));

            final Data declineData = new Data(1);
            declineData.set(DeclineIncomingUserInvitation.DataKey.INVITATION_ID, invitation.getId());
            jPopupMenu.add(popupItemFactory.createPopupItem(ActionId.CONTACT_DECLINE_INCOMING_USER_INVITATION, declineData));
