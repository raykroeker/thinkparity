...
public enum AvatarId {
    ...
    DIALOG_CONFIRM, DIALOG_CONTAINER_CREATE, DIALOG_CONTAINER_PUBLISH,
    ...
    DIALOG_PROFILE_UPDATE_PASSWORD, DIALOG_PROFILE_UPGRADE_ACCOUNT,
    DIALOG_PROFILE_UPGRADE_ACCOUNT_AGREEMENT, DIALOG_PROFILE_UPGRADE_ACCOUNT_INTRO,
    DIALOG_PROFILE_UPGRADE_ACCOUNT_PAYMENT, DIALOG_PROFILE_UPGRADE_ACCOUNT_SUMMARY,
    DIALOG_PROFILE_VERIFY_EMAIL,
    DIALOG_SHOW_LICENSE_AGREEMENT, DIALOG_STATUS,
    MAIN_CONTENT, MAIN_STATUS, MAIN_TITLE,
    TAB_CONTACT, TAB_CONTAINER, TAB_HELP
}
