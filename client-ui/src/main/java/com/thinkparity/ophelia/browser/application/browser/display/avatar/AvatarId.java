...
public enum AvatarId {
    ...
    DIALOG_CONTACT_READ, DIALOG_CONTAINER_CREATE, DIALOG_CONTAINER_EXPORT, DIALOG_CONTAINER_PUBLISH,
    DIALOG_CONTAINER_RENAME, DIALOG_CONTAINER_RENAME_DOCUMENT,
    DIALOG_CONTAINER_VERSION_COMMENT, DIALOG_ERROR,
    DIALOG_PLATFORM_CONFIRM_SYNCHRONIZE,
    DIALOG_PLATFORM_DISPLAY_INFO, DIALOG_PLATFORM_LOGIN,
    DIALOG_PROFILE_RESET_PASSWORD, DIALOG_PROFILE_EDIT,   
    DIALOG_PROFILE_UPDATE,
