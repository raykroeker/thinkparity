 ...
 * @version 
 */
public class AcceptKeyRequestTest extends ContainerTestCase {

    /** The test name. */
    private static final String NAME = "[LMODEL] [CONTAINER] [TEST ACCEPT KEY REQUEST]";

    /** Test datum. */
    private Fixture datum;

    /** Create DeclineKeyRequestTest. */
    public AcceptKeyRequestTest() { super(NAME); }
    ...
    public void testDeclineKeyRequest() {
        // send the key
        try { datum.cModel.acceptKeyRequest(datum.keyRequestId); }
