...
public final class NetworkOutputStream extends RecordingOutputStream {
    ...
    /**
     * @see com.thinkparity.net.io.RecordingOutputStream#write(byte[])
     *
     */
    @Override
    ...
    /**
     * @see com.thinkparity.net.io.RecordingOutputStream#write(byte[], int, int)
     *
     */
    @Override
    ...
    /**
     * @see com.thinkparity.net.io.RecordingOutputStream#write(int)
     *
     */
    @Override
