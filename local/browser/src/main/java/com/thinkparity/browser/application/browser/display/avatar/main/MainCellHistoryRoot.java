 ...
 * @version 1.1
 */
public class MainCellHistoryRoot implements MainCell {
    ...
    /**
     * Create MainCellHistoryRoot.
     * 
     */
    public MainCellHistoryRoot(final MainCellDocument document,
        ...
        this.l18n = new MainCellL18n("HistoryRoot");
    }
    ...
    public boolean equals(final Object obj) {
        if(null != obj && obj instanceof MainCellHistoryRoot) {
            return ((MainCellHistoryRoot) obj).document.equals(document);
        }
        return false;
    }
    ...
    public String getText() {
        return l18n.getString("HistoryRoot", new Object[] {historySize});
    }
