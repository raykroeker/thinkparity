...
public final class ClientServiceFactory implements ServiceFactory {
    ...
    private static ClientServiceFactory instance;
    ...
    public static ClientServiceFactory getInstance() {
        if (null == instance) {
            try {
                instance = new ClientServiceFactory();
            } catch (final HttpException hx) {
                throw new ServiceException(hx);
            }
        }
        return instance;
    }
     ...
     *
     */
    private ClientServiceFactory() throws HttpException {
        super();
