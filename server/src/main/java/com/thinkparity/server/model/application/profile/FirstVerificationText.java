 ...
 * @version 1.1.2.1
 */
public class FirstVerificationText {
     ...
     *            The inviter user.
     */
    FirstVerificationText(final Locale locale, final EMail verificationEmail,
            final VerificationKey verificationKey) {
        super();
        this.verificationEmail = verificationEmail;
        this.verificationKey = verificationKey;
        this.resourceBundle = ResourceBundle.getBundle(
                "localization.FirstVerification_Messages", locale);
    }
