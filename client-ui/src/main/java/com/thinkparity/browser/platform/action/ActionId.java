...
public enum ActionId {
    ...
    CONTAINER_ADD_DOCUMENT, CONTAINER_CREATE, CONTAINER_CREATE_DRAFT,
    CONTAINER_DELETE, CONTAINER_DELETE_DRAFT, CONTAINER_EXPORT,
    ...
    DOCUMENT_PRINT_VERSION, DOCUMENT_RENAME, DOCUMENT_UPDATE_DRAFT,
