Desdemona (Othello)
    Desdemona is a fictional character in the play Othello by  William
Shakespeare. She is Othello's wife, and the daughter of Senator Brabantio. She
...
Source Tree
    +>desdemona
        ...
        +>vendor                    // All vendor libraries live in vendor
            +>junit                 // organized by the library then version.
            +>log4j
            +>messenger
