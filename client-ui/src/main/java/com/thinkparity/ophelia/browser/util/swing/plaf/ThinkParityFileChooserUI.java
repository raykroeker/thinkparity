/**
 * Created On: Mar 12, 2007 10:50:01 AM
 * $Id$
 */
...
public class ThinkParityFileChooserUI extends BasicFileChooserUI {
    ...
    /**
     * Create a thinkParity file chooser ui.
     * 
     * @param c
    ...
    public static ComponentUI createUI(final JComponent c) {
        return new ThinkParityFileChooserUI((JFileChooser) c);
    }

    /**
     * Create a ThinkParityFileChooserUI.
     * 
     * @param b
     *            A <code>JFileChooser</code>.
     */
    public ThinkParityFileChooserUI(final JFileChooser filechooser) {
        super(filechooser);
    }
    ...
    private class WindowsFileChooserUIAccessor implements
            FilePane.FileChooserUIAccessor {
        public JFileChooser getFileChooser() {
            return ThinkParityFileChooserUI.this.getFileChooser();
        }

        public BasicDirectoryModel getModel() {
            return ThinkParityFileChooserUI.this.getModel();
        }

        public JPanel createList() {
            return ThinkParityFileChooserUI.this.createList(getFileChooser());
        }

        public JPanel createDetailsView() {
            return ThinkParityFileChooserUI.this
                    .createDetailsView(getFileChooser());
        }

        public boolean isDirectorySelected() {
            return ThinkParityFileChooserUI.this.isDirectorySelected();
        }

        public File getDirectory() {
            return ThinkParityFileChooserUI.this.getDirectory();
        }

        public Action getChangeToParentDirectoryAction() {
            return ThinkParityFileChooserUI.this.getChangeToParentDirectoryAction();
        }

        public Action getApproveSelectionAction() {
            return ThinkParityFileChooserUI.this.getApproveSelectionAction();
        }

        public Action getNewFolderAction() {
            return ThinkParityFileChooserUI.this.getNewFolderAction();
        }

        public MouseListener createDoubleClickListener(JList list) {
            return ThinkParityFileChooserUI.this.createDoubleClickListener(
                    getFileChooser(), list);
        }
    ...
    public void installComponents(JFileChooser fc) {
        ...
        listViewButton.putClientProperty(
                AccessibleContext.ACCESSIBLE_NAME_PROPERTY,
        ...
        // ********************************** //
        getBottomPanel().setOpaque(false);
        getBottomPanel().setLayout(
                new BoxLayout(getBottomPanel(), BoxLayout.LINE_AXIS));
        ...
        getButtonPanel().setLayout(
                new BoxLayout(getButtonPanel(), BoxLayout.Y_AXIS));

        approveButton = new JButton(getApproveButtonText(fc)) {
            public Dimension getMaximumSize() {
                return approveButton.getPreferredSize().width > cancelButton
                        .getPreferredSize().width ? approveButton
                        .getPreferredSize() : cancelButton.getPreferredSize();
            }
        };
        Insets buttonMargin = approveButton.getMargin();
        buttonMargin = new InsetsUIResource(buttonMargin.top,
                buttonMargin.left + 5, buttonMargin.bottom,
                buttonMargin.right + 5);
        approveButton.setMargin(buttonMargin);
        approveButton.setMnemonic(getApproveButtonMnemonic(fc));
        approveButton.addActionListener(getApproveSelectionAction());
        approveButton.setToolTipText(getApproveButtonToolTipText(fc));
        approveButton.setOpaque(false);
    ...
    protected void installListeners(JFileChooser fc) {
        ...
        FilePane.addActionsToMap(actionMap, filePane.getActions());
