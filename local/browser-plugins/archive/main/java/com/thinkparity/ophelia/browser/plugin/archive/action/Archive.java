 ...
 * @version 1.1.2.1
 */
public class Archive extends ActionExtensionAction {
    
    /**
     * Create Archive.
     * 
     */
    public Archive(final PluginServices services, final ActionExtension extension) {
    ...
    protected void invoke(final Object selection) {
        ...
        if(confirm("ConfirmArchive", container.getName())) {
