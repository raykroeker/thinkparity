...
public class ImageBorder extends AbstractBorder {
     ...
     *            The left image name.
     * @param bottomName
     *            The bottom image name.
     * @param rightName
     *            The right image name.
     */
    public ImageBorder(final String topName, final String leftName,
            final String bottomName, final String rightName) {
        this(ImageIOUtil.read(topName), ImageIOUtil.read(leftName),
                ImageIOUtil.read(bottomName), ImageIOUtil.read(rightName));
    }
