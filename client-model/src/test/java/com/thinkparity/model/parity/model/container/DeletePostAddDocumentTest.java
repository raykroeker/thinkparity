 ...
 * @version 1.1.4.5
 */
public class DeletePostAddDocumentTest extends ContainerTestCase {

    /** The test name. */
    private static final String NAME = "[TEST DELETE POST ADD DOCUMENT]";

    /** Test datum. */
    private Fixture datum;

    /** Create DeletePostAddDocumentTest. */
    public DeletePostAddDocumentTest() { super(NAME); }
