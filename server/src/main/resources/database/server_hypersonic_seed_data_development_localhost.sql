...
insert into jiveUser (USERNAME,PASSWORD,CREATIONDATE,MODIFICATIONDATE)
    values('archive.rkroeker','parity',0,0);
insert into jiveVCard (USERNAME,VALUE)
    values('archive.rkroeker', '<vCard xmlns="vcard-temp"><FN>Archive</FN><N><FAMILY>Archive</FAMILY><GIVEN></GIVEN></N><ORG><ORGNAME>thinkParity Solutions Inc.</ORGNAME></ORG></vCard>');
insert into PARITY_USER_PROFILE (USERNAME,SECURITY_QUESTION,SECURITY_ANSWER,DISABLED)
    values('archive.rkroeker','What is my username?','archive.rkroeker',false);
insert into PARITY_USER_ARCHIVE_REL (USERNAME,ARCHIVENAME)
    values('rkroeker', 'archive.rkroeker');
