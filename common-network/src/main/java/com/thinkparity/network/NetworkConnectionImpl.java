...
class NetworkConnectionImpl implements NetworkConnection {
    ...
    /**
     * @see com.thinkparity.network.NetworkConnection#connect(com.thinkparity.network.NetworkProxy)
     *
     */
    @Override
    ...
    /**
     * @see com.thinkparity.network.NetworkConnection#connect(com.thinkparity.network.NetworkTunnel)
     *
     */
    @Override
