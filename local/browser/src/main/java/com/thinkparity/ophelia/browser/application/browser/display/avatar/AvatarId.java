...
public enum AvatarId {
    ...
    DIALOG_CONTACT_READ, DIALOG_CONTAINER_CREATE, DIALOG_CONTAINER_PUBLISH, DIALOG_ERROR,
    DIALOG_PLATFORM_DISPLAY_INFO, DIALOG_PLATFORM_LOGIN, DIALOG_PROFILE_RESET_PASSWORD, DIALOG_PROFILE_UPDATE,
