 ...
 * @version 1.1
 */
public class IQInviteContactProvider implements IQProvider {
	...
	/**
	 * Create a IQInviteContactProvider.
	 * 
	 */
	public IQInviteContactProvider() {
		super();
	...
	public IQ parseIQ(final XmlPullParser parser) throws Exception {
		...
		return new IQInviteContact(contact);
	}
