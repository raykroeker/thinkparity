...
/**
 * This border draws a single pixel line at the left and right edges of the
 * component.
 * 
 * @author raymond@raykroeker.com
 * @version 1.1
 */
public class LeftRightBorder extends AbstractBorder {
	 ...
	 * 
	 */
	public LeftRightBorder(final Color color) {
		super();
		this.color = color;
	}
