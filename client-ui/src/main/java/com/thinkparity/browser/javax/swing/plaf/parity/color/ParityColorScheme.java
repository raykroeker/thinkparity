 ...
 * @version 1.1
 */
public class ParityColorScheme implements ColorScheme {
	...
	static {
		...
		ULTRA_LIGHT_COLOR = new Color(97, 139, 214);
		EXTRA_LIGHT_COLOR = new Color(97, 139, 214);
		LIGHT_COLOR = new Color(90, 130, 196);
		MID_COLOR = new Color(90, 130, 196);
		DARK_COLOR = new Color(82, 119, 175);
		ULTRA_DARK_COLOR = new Color(82, 119, 175);
	}
