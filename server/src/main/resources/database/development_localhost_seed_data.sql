...
insert into TPSD_PRODUCT_RELEASE(PRODUCT_ID,RELEASE_NAME,RELEASE_OS,RELEASE_DATE)
    select PRODUCT_ID,'DEVELOPMENT','LINUX',CURRENT_TIMESTAMP from TPSD_PRODUCT where PRODUCT_NAME='OpheliaProduct';
insert into TPSD_PRODUCT_RELEASE(PRODUCT_ID,RELEASE_NAME,RELEASE_OS,RELEASE_DATE)
    select PRODUCT_ID,'DEVELOPMENT','WINDOWS_XP',CURRENT_TIMESTAMP from TPSD_PRODUCT where PRODUCT_NAME='OpheliaProduct';
