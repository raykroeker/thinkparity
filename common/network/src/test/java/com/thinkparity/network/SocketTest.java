 ...
 * @version 1.1.2.1
 */
public final class SocketTest extends NetworkTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        if (false == SocketTestServer.isRunning()) {
            SocketTestServer.start(newServerAddress());
        }
        datum = new Fixture(new Network(), NetworkProtocol.getProtocol("socket"));
    }
