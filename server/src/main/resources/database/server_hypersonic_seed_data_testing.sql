...
insert into PARITY_USER_PROFILE (USERNAME,SECURITY_QUESTION,SECURITY_ANSWER,DISABLED)
    values('junit', 'What is my username?', 'junit',false);
...
insert into PARITY_USER_PROFILE (USERNAME,SECURITY_QUESTION,SECURITY_ANSWER,DISABLED)
    values('junit.x', 'What is my username?', 'junit.x',false);
...
insert into PARITY_USER_PROFILE (USERNAME,SECURITY_QUESTION,SECURITY_ANSWER,DISABLED)
    values('junit.y', 'What is my username?', 'junit.y',false);
...
insert into PARITY_USER_PROFILE (USERNAME,SECURITY_QUESTION,SECURITY_ANSWER,DISABLED)
    values('junit.z', 'What is my username?', 'junit.z',false);
